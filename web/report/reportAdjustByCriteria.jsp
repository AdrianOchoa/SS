...
<html>
    <head>
        ...
        <title>Reporte ajuste por criterio</title>
    ...
    <body>
        ...
        <div class="container">
            ...
            <form class="well form-horizontal" method="post"  action="${pageContext.request.contextPath}/ReportAdjustByCriteriaServlet">
            ...
            <c:if test="${not empty result}">
                <div class="row">
                            ...
                            <tbody>
                                ...
                                <form method="post" action="${pageContext.request.contextPath}/ReportGetDetailedReport">
                                    <tr>
                                        ...
                                        <td class="text-center text-nowrap">${element.tipoCriterio}</td>
                                        <td class="text-center text-nowrap">${element.numeroHits}</td>
                                        ...
                                        <td class="text-center text-nowrap">
                                            ...
                                            <input name="type" type="hidden" value="ajusteCriterio">
                    ...
                    <div class="row">
                        ...
                        <a class="btn btn-success" onclick="tableToExcel('tableData', 'Resultados', 'ajuste_criterio.xls');">Exportar</a>
                    </div>
                </c:if>
            </div>
        </div>
