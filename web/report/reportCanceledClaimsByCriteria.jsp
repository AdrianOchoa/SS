...
<html>
    <head>
        ...
        <title>Reporte cancelacion por criterio</title>
    ...
    <body>
        ...
        <div class="container">
            <hr>
            <form class="well form-horizontal" method="post"  action="${pageContext.request.contextPath}/ReportCanceledClaimsByCriteriaServlet">
            ...
            <c:if test="${not empty result}">
                                ...
                                <form method="post" action="${pageContext.request.contextPath}/ReportGetDetailedReport">
                                    <tr>
                                        ...
                                        <td class="text-center text-nowrap">
                                            ...
                                            <input name="type" type="hidden" value="canceladosCriterio">
                ...
                <div class="row">
                    ...
                    <a class="btn btn-success" onclick="tableToExcel('tableData', 'Resultados', 'cancelaciones_criterio.xls');">Exportar</a>
                </div>
            </c:if>
        </div>
    </body>
