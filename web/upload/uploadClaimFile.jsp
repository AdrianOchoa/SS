...
<html>
    <head>
        ...
        <title>Subir archivo Claim Criteria</title>
        ...
        <div class="container">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <!-- Standar Form -->
                    <h4>Selecciona archivo Claim Criteria</h4>
                    <form action="${pageContext.request.contextPath}/UploadClaimFileServlet" method="post" enctype="multipart/form-data" id="js-upload-form">
                    ...
                    <div class="js-upload-finished">
                        ...
                        <div class="list-group">
                            <a href="#" class="list-group-item list-group-item-success"><span class="badge alert-success pull-right">Terminado</span>claim_criteria_agosto.xlsx</a>
                        </div>
                    </div>
                </div>
            </div>
