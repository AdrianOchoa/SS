 ...
 */
@WebServlet("/ReportTotalClaimsByBrandServlet")
public class ReportTotalClaimsByBrandServlet extends HttpServlet {
    ...
    protected void doPost (HttpServletRequest request, HttpServletResponse response)
        ...
        List<ResultSetForTotalClaims> result = 
                new ReportingService().generateTotalClaimsByBrandReport(initialDate, finalDate);
        HttpSession session = request.getSession();
        session.setAttribute("result", result);
        nextPage = "report/reportTotalClaimsByBrand.jsp";
