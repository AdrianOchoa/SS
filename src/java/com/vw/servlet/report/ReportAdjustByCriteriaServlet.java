 ...
 */
@WebServlet("/ReportAdjustByCriteriaServlet")
public class ReportAdjustByCriteriaServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        List<ResultSet> result = 
                new ReportingService().generateAdjustByCriteriaReport(initialDate, finalDate);
        HttpSession session = request.getSession();
        session.setAttribute("result", result);
        session.setAttribute("initialDate", initialDate);
        session.setAttribute("finalDate", finalDate);
        nextPage = "report/reportAdjustByCriteria.jsp";
